...
import { 
  ShieldCheck, Sparkles, Check, ArrowRight, Video, FileText, 
  Lock, Play, AlertTriangle, ChevronRight, Star, Clock, 
  HelpCircle, ShieldAlert, Cpu, BarChart3, Smartphone, ExternalLink, 
  Package, Zap, Scale, CheckCircle2, Laptop, Gamepad2, Watch, Maximize2, X
} from 'lucide-react';
...
export const LandingPage: React.FC<LandingPageProps> = ({
  ...
  const estimatedRoi = estimatedMonthlyLoss > 0 
    ? Math.round(((estimatedMonthlyLoss - provapackCost) / provapackCost) * 100) 
    : 0;
...
O ProvaPack não garante o resultado de uma disputa, que continua sujeito às regras e à análise de cada marketplace. Seu objetivo é aumentar a organização, rastreabilidade e integridade técnica das evidências apresentadas.`
  ...
  return (
    <div className="space-y-20 pb-16 font-['Plus_Jakarta_Sans',sans-serif]">
      {/* 1. Urgency Notification Top Banner */}
      <div className="bg-gradient-to-r from-rose-950/80 via-amber-950/80 to-slate-900 border border-rose-800/50 rounded-2xl p-3 sm:p-4 text-center shadow-lg">
        <div className="flex flex-wrap items-center justify-center gap-2 text-xs sm:text-sm font-medium text-rose-200">
          <span className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full bg-rose-500/20 text-rose-300 font-bold text-[11px] border border-rose-500/30">
            <AlertTriangle className="w-3.5 h-3.5 text-rose-400" />
            Alerta aos Vendedores
          </span>
          <span>
            Golpes de devolução (caixa vazia e troca de aparelho) geraram mais de <strong>US$ 103 bilhões em prejuízos</strong> no e-commerce global.
          </span>
          <button 
            onClick={onStartTrial}
            className="underline font-bold text-sky-400 hover:text-sky-300 ml-1"
          >
            Proteja seus envios grátis →
          </button>
        </div>
      </div>
      ...
      <section className="relative text-center max-w-4xl mx-auto pt-4 sm:pt-8">
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-bold bg-sky-950 text-sky-400 border border-sky-800/90 shadow-inner mb-6">
          <Sparkles className="w-4 h-4 text-sky-400" />
          <span>Prova-como-Serviço para Mercado Livre, Shopee & Amazon</span>
        </div>

        <h1 className="text-3xl sm:text-5xl lg:text-6xl font-black text-white tracking-tight leading-[1.15]">
          Nunca Mais Perca Dinheiro com o <span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-400 via-blue-400 to-indigo-400">Golpe da Caixa Vazia</span> ou Produto Trocado.
        </h1>
        ...
        <div className="mt-4 flex flex-wrap items-center justify-center gap-4 text-xs text-slate-400 font-medium">
        ...
        <div className="mt-12 relative rounded-3xl bg-slate-900 border border-slate-800 p-4 sm:p-7 shadow-2xl text-left overflow-hidden group">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-4 mb-4 border-b border-slate-800">
            <div>
              <span className="text-[11px] font-bold uppercase tracking-wider text-slate-400 block mb-1">
                Selecione um tipo de produto para ver as fotos reais de conferência:
              </span>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <span className="text-xs text-emerald-400 font-semibold bg-emerald-950/80 border border-emerald-800/80 px-2 py-0.5 rounded">
          ...
          <div className="mt-4">
            <div className="flex items-center justify-between text-[11px] text-slate-400 mb-2.5 font-medium">
              <span className="flex items-center gap-1.5">
                ...
                7 Marcos Obrigatórios Registrados Sem Cortes ({activeProduct.durationSeconds} segundos)
              </span>
          ...
          <div className="mt-4 pt-3 border-t border-slate-800/80 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 text-[11px] text-slate-400 font-mono">
            ...
            <span className="text-emerald-400 font-sans font-semibold shrink-0">
              ✓ Aceito em Mediações de E-commerce
            </span>
          </div>
        </div>
            ...
            >
              ...
              <div className="relative aspect-video rounded-xl overflow-hidden bg-black border border-slate-800 mb-4 shadow-inner">
                ...
                <div className="absolute bottom-2 left-2 bg-slate-950/90 backdrop-blur-xs px-2.5 py-1 rounded text-xs font-mono text-emerald-400 font-semibold border border-slate-800">
                  ✓ Registro Contínuo sem Cortes • Timestamp: {activePhotoModal.tag}
                </div>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="rounded-3xl bg-rose-950/20 border border-rose-900/40 p-6 sm:p-7 relative overflow-hidden">
            <div className="flex items-center gap-2 text-rose-400 font-bold text-sm mb-4">
              ...
              <span>Sem o ProvaPack (O que acontece hoje)</span>
            </div>
            ...
            <ul className="space-y-3.5 text-xs sm:text-sm text-slate-300">
              ...
              <li className="flex items-start gap-2.5">
                <span className="text-rose-500 font-bold shrink-0">✕</span>
                <span>Sem comprovação de que o vídeo não foi cortado ou editado após o pacote sair da bancada.</span>
              </li>
              <li className="flex items-start gap-2.5">
                <span className="text-rose-500 font-bold shrink-0">✕</span>
                <span>O comprador alega que recebeu uma caixa vazia e o marketplace reembolsa imediatamente.</span>
              </li>
              <li className="flex items-start gap-2.5">
                <span className="text-rose-500 font-bold shrink-0">✕</span>
                <span>Sua conta cai de reputação, o dinheiro é estornado e você fica sem o produto.</span>
              </li>
            </ul>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          <div className="p-6 rounded-2xl bg-slate-900 border border-slate-800 relative">
            ...
            <p className="mt-2 text-xs text-slate-400 leading-relaxed">
              O assistente indica o que mostrar em cada segundo: produto 360°, display ligado, número de série na caixa, acessórios, acondicionamento, fita e etiqueta.
            </p>
          </div>
      ...
      <section className="max-w-4xl mx-auto rounded-3xl bg-gradient-to-b from-slate-900 to-indigo-950/40 border border-slate-800 p-6 sm:p-9 shadow-2xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="space-y-5">
            ...
            <div>
              <div className="flex justify-between text-xs text-slate-300 font-semibold mb-1.5">
                <span>Tíquete Médio do Produto:</span>
            ...
            <div>
              <div className="flex justify-between text-xs text-slate-300 font-semibold mb-1.5">
                <span>Índice Estimado de Contestações / Devoluções:</span>
          ...
          <div className="p-6 rounded-2xl bg-slate-950/80 border border-slate-800 text-center">
            ...
            <div className="p-3 rounded-xl bg-emerald-950/50 border border-emerald-800/80 text-emerald-300 text-xs">
              <strong>Retorno Estimado (ROI): {estimatedRoi > 0 ? `+${estimatedRoi}%` : 'Imediato'}</strong>
              <span className="block text-[11px] text-emerald-400/80 mt-0.5">
                Basta recuperar 1 único pedido contestado para pagar o ano inteiro da ferramenta.
              </span>
            </div>
      ...
      <section className="max-w-4xl mx-auto text-center rounded-3xl bg-gradient-to-r from-sky-600 via-blue-600 to-indigo-700 p-8 sm:p-12 shadow-2xl relative overflow-hidden">
        <div className="relative z-10">
          ...
          <h2 className="text-2xl sm:text-4xl font-black text-white tracking-tight">
            Pronto para acabar com os prejuízos de devolução no seu e-commerce?
          </h2>

          <p className="mt-3 text-xs sm:text-base text-blue-100 max-w-xl mx-auto leading-relaxed">
            Faça seu primeiro empacotamento guiado agora mesmo. Você ganha <strong>10 dossiês gratuitos</strong> para testar na sua bancada sem compromisso.
          </p>
